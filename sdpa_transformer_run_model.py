...
import sdpa_transformer_model as sdpa_model
import common as cm

class sdpa_transformer_e2e:
    '''
    Trains and evaluates scaled dot product attention transformer model.
    '''

    def __init__(self, tokenizer_obj_src, tokenizer_obj_tgt, hpdict=None,
                 checkpoint_path = "./sdpa_checkpoints/", load_ckpt=None):
        ...
        if hpdict:
            ...
            self.hpdict={"num_layers": 4,
                         ...
                         "pe_target":1000,
                         "epochs": 40,
                         "save_model_path": "./default_sdpa_transformer", #name to save parameters and checkpoints with. This is file name
        ...
        self.transformer = sdpa_model.SDPA_Transformer(
    ...
    def evaluate(self, sentence, max_length=50, save_att=None):
        ...
        for i in range(eval_max_length):
            ...
            if predicted_id == end:# or tf.shape(output)[1]>=39:
                break
    ...
    def beam_evaluate(self, sentence, beam_size=4, max_length=50):
        ...
        for i in range(eval_max_length):
            if not beam_out:  # corner case if all sentences saw eos and nowhere to go
                break
            new_sequences=[]
